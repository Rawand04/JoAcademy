        ...
        <div className="flex border-b border-gray-200 mb-8">
          <button
            ...
            className={`flex-1 pb-4 text-lg font-bold transition-all ${
              isByPhone ? "border-b-4 border-[#1a408c] text-[#1a408c]" : "text-gray-500"
            }`}
          >
            By Phone
          </button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex items-center gap-2 px-4 py-3 border border-gray-300 rounded-lg bg-white min-w-[100px]">
                  <span>962+</span>
                  <img src="https://flagcdn.com/w20/jo.png" alt="Jordan" className="w-5 h-3 object-cover rounded-sm" />
                </div>
                <input
                  ref={phoneRef}
                  type="tel"
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <div className="text-right">
                  <Link href="/forget-password" title="Forgot Password" className="text-sm text-blue-600 hover:underline">
                    Forgot Password?
                  </Link>
                </div>
              </div>
